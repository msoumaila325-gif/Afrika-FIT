...
export default function Pricing({ isEmbedded = false }: PricingProps) {
  ...
  return (
    <section id="pricing" className={`${isEmbedded ? 'py-4 bg-transparent' : 'py-24 bg-luxury-gradient relative overflow-hidden'}`}>
      {/* Decorative glows */}
      {!isEmbedded && (
        <>
